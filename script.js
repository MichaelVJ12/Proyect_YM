...
function mostrarOcultarBlur(element, button) {
    ...
    if (element == document.getElementById("login-slap")) {
        loginZIndex(element);
    }
}
...
function mostrarOcultar(mostrar, button1, ocultar, button2) {
    ...
    if (mostrar == document.getElementById("login-slap")) {
        loginZIndex(mostrar);
    }
...
bag_button.addEventListener("click", function () {
    mostrarElemento(1);
});
...
exit_bag.addEventListener("click", function () {
    mostrarElemento(1);
});
exit_favorite.addEventListener("click", function () {
    mostrarElemento(2);
});
exit_search.addEventListener("click", function () {
    mostrarElemento(3);
});
